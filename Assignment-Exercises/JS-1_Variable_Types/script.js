...
// Using let
let Pinky; // Define a string here, e.g., "Juan Cruz"
...
// Using const
const pi = 3.20; // Define a number here, e.g., 3.14159
const birthYear = 2003; // Define a number here, e.g., 1990
const isEmployed = false; // Define a boolean here, e.g., true or false
const favoriteBooks = ["Hunger Games", "Divergent", "City of Bones"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// Using var
var city = "Las Vegas"; // Define a string here, e.g., "New York"
var temperature = 30; // Define a number here, e.g., 22.5
var hasPets = true; // Define a boolean here, e.g., true or false
var colors = ["pink", "yellow", "white"]; // Define an array here, e.g., ["red", "green", "blue"]
